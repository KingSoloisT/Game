...
{
		obj_BattlePlayer.sprite_index = spr_mech1;
}
if ( global.turn == "player2")
{
		obj_BattlePlayer.sprite_index = spr_mech2;
}
if ( global.turn == "player3")
{
		obj_BattlePlayer.sprite_index = spr_mech3;
}
if ( global.turn == "player4")
{
		obj_BattlePlayer.sprite_index = spr_mech4;
}


if (global.battle_enemy == "enemy1")
{	
	obj_BattleEnemy.sprite_index = spr_player;
}
if (global.battle_enemy == "enemy2")
{	
	//obj_BattleEnemy.sprite = spr_enemy1; //ADD OTHER ENEMIES HERE!
}
